...
vi.mock('@blocksuser/gemini-cli-core', async () => {
  const actual = await vi.importActual('@blocksuser/gemini-cli-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@blocksuser/gemini-cli-core';
import { uiTelemetryService } from '@blocksuser/gemini-cli-core';
